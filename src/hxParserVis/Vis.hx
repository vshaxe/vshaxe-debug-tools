...
class Vis_NExpr {
	static public function vis(ctx:SyntaxTreePrinter, v:hxParser.ParseTree.NExpr):String {
		return switch v {
			...
			case PDollarIdent(ident):"<span class=\"node\">PDollarIdent</span>" + "<ul>" + "<li>" + "ident: " + VisBase.visToken(ctx, ident) + "</li>" + "</ul>";
...
class Vis_NComplexType {
	static public function vis(ctx:SyntaxTreePrinter, v:hxParser.ParseTree.NComplexType):String {
		return switch v {
			...
			case PAnonymousStructure(bropen, fields, brclose):"<span class=\"node\">PAnonymousStructure</span>" + "<ul>" + "<li>" + "bropen: " + VisBase.visToken(ctx, bropen) + "</li>" + "<li>" + "fields: " + Vis_NAnonymousTypeFields.vis(ctx, fields) + "</li>" + "<li>" + "brclose: " + VisBase.visToken(ctx, brclose) + "</li>" + "</ul>";
